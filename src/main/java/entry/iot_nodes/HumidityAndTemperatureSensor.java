...
public class HumidityAndTemperatureSensor extends Sensor {
    private static int instanceCount = 0;
    private final String localTopic;

    public HumidityAndTemperatureSensor(String brokerString, String clientId, String username, String password) {
        super(brokerString, clientId, username, password);
        this.sensorType = SensorType.HUMIDITY_AND_TEMPERATURE;
    ...
    public void publishData() throws MqttException {
        try {
                ...
                while (true) {
                    String data = GenerateData.generateHumidityAndTemperature().toString();
